...
object GBT_Prediction{
  ...
  def main(args: Array[String]): Unit ={
    ...
    val featureImportances = bestModel
      .stages
      .last
      .asInstanceOf[GBTRegressionModel].featureImportances.toArray;
    ...
    cvModel.transform(Preprocessing.testData)
      ...
      .option("header", "true")
      .save("data/allstate_claims_severity/output/result_GBT.csv");
  }
